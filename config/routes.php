...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/', function (RouteBuilder $builder): void {
        ...
        $builder->connect('/home', ['controller' => 'Homes', 'action' => 'index']);
        $builder->connect('/adminbooking', ['controller' => 'Adminbookings', 'action' => 'index']); 
        $builder->connect('/hall', ['controller' => 'Halls', 'action' => 'index']);
        $builder->connect('/package', ['controller' => 'Packages', 'action' => 'index']);
