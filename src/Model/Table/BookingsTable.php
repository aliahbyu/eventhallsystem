 ...
 * @property \App\Model\Table\AdminbookingsTable&\Cake\ORM\Association\HasMany $Adminbookings
...
class BookingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('receipt_path')
            ->maxLength('receipt_path', 255)
            ->allowEmptyString('receipt_path');
